			...
			<div class="boardcontents">
				<div id="contents">
					<ul class="tabs">
						...
						<li class="tab-link" data-tab="tab-2" onclick="location.href='${path}/profile/my_ex_reply?num=1'">내가 쓴 댓글</li>
					</ul>
					...
					<div id="tab-1" class="tab-content current" style="height: 525px;">
						...
						<div class="btns">
							<ul class="pagination">
								<c:if test="${page.prev}">
									<li>
										[<a href='${path}/profile/my_ex?num=${page.startPageNum-1}'>이전</a>]
									</li>
								</c:if>
								<c:forEach begin="${page.startPageNum}" end="${page.endPageNum}" var="num">
									<li>
										<c:if test="${select != num}">
											<a href="${path}/profile/my_ex?num=${num}">${num}</a>
										</c:if>
										<c:if test="${select == num}">
								...
								<c:if test="${page.next}">
									<li>
										[<a href="${path}/profile/my_ex?num=${page.endPageNum+1}">다음</a>]
									</li>
								</c:if>
							</ul>
						</div>
